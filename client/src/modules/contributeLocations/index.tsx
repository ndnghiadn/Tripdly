...
export const ContributeLocation = () => {
  ...
  useEffect(() => {
    if (!current || current.role !== "Guide") router.push("/app");
  }, [current]);
  ...
  async function handleCreateLocation() {
    ...
    if (isValid) {
      ...
      const res = await axiosClient.post("/locations", form, {
        ...
        <div className="container-contribute m-10 rounded-xl p-10 bg-slate-100">
          <div className="title-contribute">
            <h1 className="text-4xl font-semibold">
              Please contribute the locations you think is good for tripdly
            </h1>
          </div>
          <div className="main-contribute flex mt-10 gap-8">
            <div className="left-contribute grow-[1] flex flex-col gap-6">
              <div className="flex flex-col gap-2 font-semibold">
                <label htmlFor="name location">Addres of location :</label>
                <Input
                  className={!validAddress ? " border-red-200" : ""}
              ...
              <div className="flex flex-col gap-2 font-semibold">
                <label htmlFor="name location">Description of location :</label>
                <TextArea
                  rows={5}
              ...
              <Button onClick={handleCreateLocation}>Contribute</Button>
            </div>
